...
class Generator:
    ...
    @classmethod
    def create_slug_shortcode(cls, size: str, model_: Any):
    ...
    @classmethod
    def create_code_for_reset(cls, size: str, model_: Any):
    ...
    @classmethod
    def create_code_for_activate(cls, size: str, model_: Any):
        new_code = cls.code_slug_generator(size=size, chars=string.digits)
